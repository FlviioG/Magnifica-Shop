...
object Constants {
    ...
    const val CHANNEL_ID = "CHANNEL_NOTIFICATIONS"
    const val IS_LOW_MEMORY_DEVICE = "LOW_MEMORY"
    const val ACTUAL_VIEW = "ACTUAL_VIEW"
    const val PEDIDO = "PEDIDO"
    const val ENTREGA = "ENTREGA"
    const val ACTUAL_LIST = "ACTUAL_LIST"
     ...
     */
    private const val PAYMENT_GATEWAY_TOKENIZATION_NAME = "mpgs"
